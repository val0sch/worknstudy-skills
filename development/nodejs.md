...
- Comment développer en utilisant un système de _livereloading_ (`nodemon` par exemple) ✔️
  Permet de recharger l'application automatiquement à chaque modification, ou sauvegarde de la page.  
  Possibilité de modifier le script dans le package.json
